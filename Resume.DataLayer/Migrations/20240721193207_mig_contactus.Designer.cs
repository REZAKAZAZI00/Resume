...
namespace Resume.DataLayer.Migrations
{
    ...
    [Migration("20240721193207_mig_contactus")]
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthDate = new DateTime(2024, 7, 21, 23, 2, 6, 897, DateTimeKind.Local).AddTicks(3495),
                            CreateDate = new DateTime(2024, 7, 21, 23, 2, 6, 897, DateTimeKind.Local).AddTicks(3508),
