...
namespace Resume.DataLayer.Migrations
{
    ...
    [Migration("20240730194116_mig_all")]
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.AboutMe.AboutMe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 7, 30, 23, 11, 15, 574, DateTimeKind.Local).AddTicks(385),
                            Location = "",
                            PictureName = "",
                            UserId = 1
                        });
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.Education.Education", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 7, 30, 23, 11, 15, 574, DateTimeKind.Local).AddTicks(405),
                            Degree = "Bachelor's",
                            Description = "",
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthDate = new DateTime(2024, 7, 30, 23, 11, 15, 574, DateTimeKind.Local).AddTicks(287),
                            CreateDate = new DateTime(2024, 7, 30, 23, 11, 15, 574, DateTimeKind.Local).AddTicks(288),
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.WorkExperiences.WorkExperiences", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 7, 30, 23, 11, 15, 574, DateTimeKind.Local).AddTicks(526),
