...
namespace Resume.DataLayer.Migrations
{
    ...
    [Migration("20240727180754_mig_add_deeplink")]
    partial class mig_add_deeplink
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.AboutMe.AboutMe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 7, 27, 21, 37, 53, 412, DateTimeKind.Local).AddTicks(6014),
                            Location = "",
                            PictureName = "",
                            UserId = 1
                        });
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.Education.Education", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 7, 27, 21, 37, 53, 412, DateTimeKind.Local).AddTicks(6035),
                            Degree = "Bachelor's",
                            Description = "",
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthDate = new DateTime(2024, 7, 27, 21, 37, 53, 412, DateTimeKind.Local).AddTicks(5897),
                            CreateDate = new DateTime(2024, 7, 27, 21, 37, 53, 412, DateTimeKind.Local).AddTicks(5898),
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.WorkExperiences.WorkExperiences", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 7, 27, 21, 37, 53, 412, DateTimeKind.Local).AddTicks(6180),
