...
namespace Resume.DataLayer.Migrations
{
    ...
    [Migration("20240731093112_mig_field_Position")]
    partial class mig_field_Position
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.AboutMe.AboutMe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 7, 31, 13, 1, 12, 101, DateTimeKind.Local).AddTicks(2134),
                            Location = "",
                            PictureName = "",
                            UserId = 1
                        });
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.Education.Education", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 7, 31, 13, 1, 12, 101, DateTimeKind.Local).AddTicks(2159),
                            Degree = "Bachelor's",
                            Description = "",
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthDate = new DateTime(2024, 7, 31, 13, 1, 12, 101, DateTimeKind.Local).AddTicks(2011),
                            CreateDate = new DateTime(2024, 7, 31, 13, 1, 12, 101, DateTimeKind.Local).AddTicks(2012),
            ...
            modelBuilder.Entity("Resume.DataLayer.Entities.WorkExperiences.WorkExperiences", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 7, 31, 13, 1, 12, 101, DateTimeKind.Local).AddTicks(2354),
